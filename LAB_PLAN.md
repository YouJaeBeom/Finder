...
> 개인용 주간 다이제스트를 연구실 인원이 함께 쓰는 형태로 확장하는 계획서.
...
enabled: true
top_n: 20                        # 주당 최대 페이지 수 (lab limits 초과 시 실행 거부)
...
| 채점 (멤버별) | 10명 × 3배치 × $0.0061 | $0.18 |
| 뉴스 (공용) | 5편 × $0.0148 | $0.07 |
| **합계** | | **≈ $3.2 / 주 ≈ $14 / 월** |
...
- [ ] **Slack 주간 알림** ("이번 주 N편, 3명 이상이 받은 논문은 …")
