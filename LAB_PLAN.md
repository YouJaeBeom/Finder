...
gpt-5.6-terra 기준 ($2/$12 per MTok). 채점 배치(20편) $0.0129, 노트 1편 $0.0115.

| 항목 | 계산 | 월간 |
|---|---|---|
| 채점 (멤버별) | 10명 × 25배치 × $0.0129 | $3.23 |
| 노트 (멤버별) | 10명 × 25편 × $0.0115 | $2.88 |
...
"어느 달에 논문이 쏟아져도" 비용이 넘지 못하는 천장이다.
...
- [x] ~~키워드를 멤버의 일에서 제거~~ **완료** — 생성기를 만들었다가, 측정 결과
      어떤 규칙도 관련 논문을 잃는다는 것이 확인되어 단계 자체를 없앴다
- [ ] `members validate` 드라이런 — 예상 채점 편수와 비용

**근거**: 멤버에게 요구할 것은 연구 소개 문단 하나여야 하고, 지금은 그렇다.
